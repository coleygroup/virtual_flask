...
def reset_psql():
    ...
    table_name = "test_networks"
    cur.execute(f"DROP TABLE IF EXISTS test_networks CASCADE;")
    print(3)
    ...
    CREATE TABLE {table_name} (
        ...
        network_id int REFERENCES test_networks(network_id),
        mapped_smiles TEXT,
    ...
    CREATE TABLE {table_name} (
        ...
        network_id int REFERENCES test_networks(network_id),
        source_node_id int REFERENCES test_nodes(node_id),
        destination_node_id int REFERENCES test_nodes(node_id),
        other_data JSONB
    );
    """
